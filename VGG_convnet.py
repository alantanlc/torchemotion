...
class VGG_convnet(nn.Module):
    ...
    def __init__(self):
        ...
        # block 1:        1 x 48000 --> 64 x 300
        self.conv1a = nn.Conv1d(1, 64, kernel_size=400, padding=40+80, stride=160)
        self.conv1b = nn.Conv1(64, 64, kernel_size=400, padding=40+80, stride=160)
        self.pool1 = nn.MaxPool1d(160)

        # block 2:          64 x 300 --> 128 x 75
        self.conv2a = nn.Conv1d(64, 128, kernel_size=3, padding=1)
        self.conv2b = nn.Conv1d(128, 128, kernel_size=3, padding=1)
        self.pool2 = nn.MaxPool1d(4)

        # block 3:          128 x 75 --> 256 x 18
        self.conv3a = nn.Conv1d(128, 256, kernel_size=3, padding=1)
        self.conv3b = nn.Conv1d(256, 256, kernel_size=3, padding=1)
        self.pool3 = nn.MaxPool1d(4)

        # block 4:          256 x 18 --> 512 x 4
